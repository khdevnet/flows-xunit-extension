...
namespace Xunit.Scenario.Extension
{
    public class XunitScenarioTestClassRunner : XunitTestClassRunner
    {
        ...
        public XunitScenarioTestClassRunner(ITestClass testClass,
        ...
        {
            var shouldFailFast = Class.ToRuntimeType().GetInterfaces().Contains(typeof(IScenarioFailNotRunnedSteps));
